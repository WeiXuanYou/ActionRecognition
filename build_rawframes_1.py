...
output_dir_path = r"../../../processed_dataset"
my_src_dir_path = r"../../../dataset/"
#output_dir_path = r"../../../test_out"
#my_src_dir_path = r"../../../test_dataset/"
...
if __name__ == '__main__':
    ...
    args.out_dir = output_dir_path
    if not osp.isdir(args.out_dir):
        print(f'Creating folder: {args.out_dir}')
        os.makedirs(args.out_dir)
    #if not osp.isdir(output_dir_path):
    #    print(f'Creating folder: {args.out_dir}')
